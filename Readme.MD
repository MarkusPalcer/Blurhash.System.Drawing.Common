...
This is the implementation for use with `System.Drawing.Common`.
The algorithm core can be found here: [BlurHash.Core](https://github.com/MarkusPalcer/blurhash.net)
